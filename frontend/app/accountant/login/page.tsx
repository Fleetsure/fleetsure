...
export default function AccountantLogin() {
  ...
  const redirectIfTeamMember = async (uid: string, email: string) => {
    ...
    if (data === "accountant") router.replace("/accountant/dashboard");
    else if (data === "manager") router.replace("/manager/dashboard");
    else setError("You are not registered as an accountant. Contact your fleet owner.");
  };
      ...
      <div style={{ width: "100%", maxWidth: 400 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 14, color: "rgba(255,255,255,0.7)" }}>
            Accountant Portal — Sign in to continue
          </div>
        </div>
        ...
        <div style={{ background: "white", borderRadius: "0 0 16px 16px", padding: "28px 32px", boxShadow: "0 8px 32px rgba(0,0,0,0.1)" }}>
          ...
          <form onSubmit={handleEmail} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <button
              ...
              disabled={loading}
              style={{
                padding: "12px", background: loading ? "#7a9bb5" : "#1a3a5c",
          ...
          <p style={{ fontSize: 12, color: "#aaa", textAlign: "center", marginTop: 20, lineHeight: 1.6 }}>
            Only registered accountants can access this portal.<br />
