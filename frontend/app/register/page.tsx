    ...
    <div style={{ minHeight: "100vh", display: "flex" }}>
      ...
      <div style={{
        ...
        <div style={{ width: "100%" }}>
          ...
          <p style={{ color: "#888", fontSize: 14, margin: "0 0 32px" }}>Start managing your fleet for free</p>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div>
              <label style={{ display: "block", fontSize: 13, fontWeight: 600, color: "#555", marginBottom: 6 }}>Your Name</label>
              <input type="text" required value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} placeholder="Ramesh Kumar"
                style={{ width: "100%", padding: "11px 14px", borderRadius: 8, border: "1.5px solid #e0e0ee", background: "white", color: "#1a1a2e", fontSize: 14, boxSizing: "border-box" }} />
            </div>
            <div>
            ...
            <p style={{ textAlign: "center", fontSize: 11.5, color: "#aaa", margin: "4px 0 0" }}>
