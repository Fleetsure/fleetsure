...
// Dark-mode counterpart to `colors`. Same keys throughout so any screen can
// swap one object for the other via useColors() without touching styles.
export const darkColors: Record<keyof typeof colors, string> = {
  ...
  secondary: "#a7b7d1",
  onSecondary: "#0a1030",
  secondaryContainer: "#39485e",
  onSecondaryContainer: "#d0e1fb",
  tertiaryContainer: "#692100",
  onTertiaryContainer: "#f0865d",
  error: "#ff6f60",
  onError: "#680003",
